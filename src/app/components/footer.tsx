...
function Footer() {
  return (
    <>
        <div className="text-gray-600 body-font bg-[#E7E4F8]">
  ...
  <div className="bg-[#E7E4F8]">
    <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
     ...
     <div className='text-3xl text-gray-900" '><FaFacebook/></div> 
      <div className='text-3xl ml-3 text-white bg-slate-800 border-rounded '><LuCamera  /></div>
        <div className='text-3xl ml-3 text-gray-900'><FaSquareTwitter /></div>
